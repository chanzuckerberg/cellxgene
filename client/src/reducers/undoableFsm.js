...
const createFsmTransitions = (
  ...
  /* Single sample request by user */
  {
    event: "single user defined sample start",
    from: "init",
    to: "single user sample request in progress",
    action: stashPending,
  },
  {
    event: "request user defined sample error",
    from: "single user sample request in progress",
    to: "single user sample error in progress",
    action: skip,
  },
  {
    event: "single user defined sample error",
    from: "single user sample error in progress",
    to: "done",
    action: cancelPending,
  },
  {
    event: "single user defined sample complete",
    from: "single user sample request in progress",
    to: "done",
    action: applyPending,
  },

  /* Bulk sample request by user */
  {
    event: "bulk user defined sample start",
    from: "init",
    to: "bulk user sample request in progress",
    action: stashPending,
  },
  {
    event: "request user defined sample error",
    from: "bulk user sample request in progress",
    to: "bulk user sample request error in progress",
    action: skip,
  },
  {
    event: "bulk user defined sample error",
    from: "bulk user sample request error in progress",
    to: "done",
    action: cancelPending,
  },
  {
    event: "bulk user defined sample complete",
    from: "bulk user sample request in progress",
    to: "done",
    action: applyPending,
  },
