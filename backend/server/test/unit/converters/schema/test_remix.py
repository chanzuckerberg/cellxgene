...
class TestApplySchema(unittest.TestCase):
    ...
    def setUp(self):
        self.source_h5ad_path = f"{PROJECT_ROOT}/backend/server/test/fixtures/pbmc3k-CSC-gz.h5ad"
        self.output_h5ad_path = f"{PROJECT_ROOT}/backend/server/test/fixtures/test_remix.h5ad"
        self.config_path = f"{PROJECT_ROOT}/backend/server/test/fixtures/test_config.yaml"
        self.bad_config_path = f"{PROJECT_ROOT}/backend/server/test/fixtures/test_bad_config.yaml"
