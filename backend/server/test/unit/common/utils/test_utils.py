...
from backend.server.common.utils.utils import import_plugins
...
class TestPlugins(unittest.TestCase):
    ...
    plugins_dir = f"{PROJECT_ROOT}/backend/server/test/plugins"
    ...
    def test_import_plugins(self):
        ...
        loaded_modules = import_plugins("backend.server.test.plugins")
        # test that import plugins found the file
        self.assertEqual(["backend.server.test.plugins.foo"], [ele.__name__ for ele in loaded_modules])
