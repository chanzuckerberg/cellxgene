...
from backend.czi_hosted.common.utils.utils import find_available_port
...
FIXTURES_ROOT = PROJECT_ROOT + "/backend/czi_hosted/test/fixtures"
...
def data_with_tmp_annotations(ext: MatrixDataType, annotations_fixture=False):
    ...
    if annotations_fixture:
        shutil.copyfile(f"{PROJECT_ROOT}/backend/czi_hosted/test/fixtures/pbmc3k-annotations.csv", annotations_file)
    fname = {
        MatrixDataType.H5AD: f"{PROJECT_ROOT}/example-dataset/pbmc3k.h5ad",
        MatrixDataType.CXG: "test/fixtures/pbmc3k.cxg",
    }[ext]
