...
class TestFixupGeneSymbols(unittest.TestCase):
    def setUp(self):
        ...
        self.seurat_merged_path = (
            f"{PROJECT_ROOT}/czi_hosted/test/fixtures/schema_test_data/seurat_tutorial_merged.h5ad"
        )
        self.sctransform_path = f"{PROJECT_ROOT}/czi_hosted/test/fixtures/schema_test_data/sctransform.h5ad"
        self.sctransform_merged_path = (
            f"{PROJECT_ROOT}/czi_hosted/test/fixtures/schema_test_data/sctransform_merged.h5ad"
        )
