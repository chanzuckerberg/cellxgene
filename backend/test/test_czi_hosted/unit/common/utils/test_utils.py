...
class TestPlugins(unittest.TestCase):
    ...
    def test_import_plugins(self):
        ...
        loaded_modules = import_plugins("backend.test.test_czi_hosted.unit.plugins")
        # test that import plugins found the file
        self.assertEqual(["backend.test.test_czi_hosted.unit.plugins.foo"], [ele.__name__ for ele in loaded_modules])
