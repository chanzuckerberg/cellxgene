...
## supported and experimental usage modes
...
If you choose setup _cellxgene_ as a hosted service, you should be aware of the following risks:
...
- Your _cellxgene_ instance is likely to fall over if too many people access it at the same time, especially if they using functions that call the Python backend (such as differential expression, updating the layout, or coloring by gene).
