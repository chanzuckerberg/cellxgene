...
class NaNSomaTest(unittest.TestCase):
    ...
    def test_init(self):
        ...
        epsilon = 0.000_005
        self.assertTrue(self.data.data.X.data.df().to_numpy()[86, 0] - -0.171_469_51 < epsilon) # assuming that the integer indices in SOMA don't have to align with those of Anndata, just the obs and var indices, we can hardcode check a different value for this test
    ...
    def test_dataframe(self):
        ...
        self.assertTrue(math.isnan(data_frame_var["columns"][2][3])) # hardcode check a different index than Anndata's tests, because they don't need to align
    ...
    def test_annotation(self):
        ...
        self.assertEqual(annotations["n_rows"], 100)
        self.assertTrue(math.isnan(annotations["columns"][2][89])) # changed from anndata tests because anndata hardcoded, while this is alphabetical
