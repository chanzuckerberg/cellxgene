...
def annotation_args(func):
    ...
    @click.option(
        ...
        help="Directory of where to save annotations and gene sets; filename will be specified in the application. Incompatible with --annotations-file and --genesets-file.",
    )
    @click.option(
