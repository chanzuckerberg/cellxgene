...
from server.common.utils.matrix_utils import is_matrix_sparse, get_column_shift_encode_for_matrix_if_sparse_with_column_shift
...
class TestMatrixUtils(unittest.TestCase):
    ...
    def test__is_matrix_sparse_with_column_shift_encoding__regular_sparse_returns_true(self):
        ...
        self.assertIsNotNone(get_column_shift_encode_for_matrix_if_sparse_with_column_shift(matrix, 50))

    def test__is_matrix_sparse_with_column_shift_encoding__column_shift_returns_same_value(self):
        matrix = np.ones([2, 2])
        expected_column_shift = [1, 1]

        actual_column_shift = get_column_shift_encode_for_matrix_if_sparse_with_column_shift(matrix, 50)
    ...
    def test__is_matrix_sparse_with_column_shift_encoding__impossible_column_shift_returns_none(self):
        ...
        self.assertIsNone(get_column_shift_encode_for_matrix_if_sparse_with_column_shift(matrix, 50))
